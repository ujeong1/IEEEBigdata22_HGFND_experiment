...
[PyG Installation on Conda](https://pytorch-geometric.readthedocs.io/en/latest/notes/installation.html)
...
Run the code with following commandline
```bash
